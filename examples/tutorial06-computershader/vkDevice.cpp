...
void createLogicalDevice(vkContext& contextref) {
    ...
    vkGetDeviceQueue(contextref.logicaldevice, indices.graphicsAndComputeFamily.value(), 0, &contextref.graphicsQueue);
    vkGetDeviceQueue(contextref.logicaldevice, indices.graphicsAndComputeFamily.value(), 0, &contextref.computeQueue);
