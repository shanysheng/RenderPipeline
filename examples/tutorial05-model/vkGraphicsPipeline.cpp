...
void createGraphicsPipeline(vkContext& contextref) {
    ...
    auto vertShaderCode = readFile("shaders/model_depth_vert.spv");
    auto fragShaderCode = readFile("shaders/model_depth_frag.spv");
    ...
    pipelineLayoutInfo.pSetLayouts = &contextref.descriptorSetLayout;
...
void createRenderPass(vkContext& contextref) {
    ...
    depthAttachment.format = findDepthFormat(contextref);
