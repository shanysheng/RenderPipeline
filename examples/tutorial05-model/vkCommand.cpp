...
void recordCommandBuffer(vkContext& contextref, uint32_t imageIndex) {
    ...
    vkCmdBeginRenderPass(commandBuffer, &renderPassInfo, VK_SUBPASS_CONTENTS_INLINE);
        ...
        vkCmdBindIndexBuffer(commandBuffer, contextref.indexBuffer, 0, VK_INDEX_TYPE_UINT32);
        ...
        vkCmdDrawIndexed(commandBuffer, static_cast<uint32_t>(contextref.modelData.indices.size()), 1, 0, 0, 0);
