...
void kContext::createContext(GLFWwindow* pwindow) {
...
void kContext::setupDebugMessenger(VkInstance pinst) {
...
void kContext::cleanupDebugMessenger(VkInstance pinst) {
    if (enableValidationLayers) {
        DestroyDebugUtilsMessengerEXT(pinst, debugMessenger, nullptr);
    }
}

void kContext::createSurface(GLFWwindow* pwindow) {
    if (glfwCreateWindowSurface(instance, pwindow, nullptr, &surface) != VK_SUCCESS) {
        throw std::runtime_error("failed to create window surface!");
    }
}

void kContext::pickPhysicalDevice() {
...
void kContext::createLogicalDevice() {
...
uint32_t  kContext::findMemoryType(kContext& contextref, uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
QueueFamilyIndices  kContext::findQueueFamilies(VkPhysicalDevice pphysicalDev, VkSurfaceKHR psurface) {
...
SwapChainSupportDetails  kContext::querySwapChainSupport(VkPhysicalDevice pphysicalDev, VkSurfaceKHR psurface) {
...
bool kContext::checkDeviceExtensionSupport(VkPhysicalDevice pphysicaldevice) {
...
bool kContext::isDeviceSuitable(VkPhysicalDevice pphysicaldevice, VkSurfaceKHR psurface) {
...
VkImageView kContext::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags) {
...
void kContext::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory) {
    ...
    allocInfo.memoryTypeIndex = findMemoryType(*this, memRequirements.memoryTypeBits, properties);
...
VkShaderModule kContext::createShaderModule(const std::string& filename) {
...
void kContext::createCommandPool() {
...
void kContext::createDescriptorPool() {
...
VkCommandBuffer kContext::beginSingleTimeCommands() {
...
void kContext::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
...
void kContext::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
...
VkFormat kContext::findSupportedFormat(const std::vector<VkFormat>& candidates, VkImageTiling tiling, VkFormatFeatureFlags features) {
...
bool kContext::hasStencilComponent(VkFormat format) {
    return format == VK_FORMAT_D32_SFLOAT_S8_UINT || format == VK_FORMAT_D24_UNORM_S8_UINT;
}



void kContext::createImage(uint32_t width, uint32_t height, VkFormat format,
